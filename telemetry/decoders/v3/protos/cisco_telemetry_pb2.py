...
_TELEMETRY = _descriptor.Descriptor(
  name='Telemetry',
  full_name='cisco_telemetry.Telemetry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='node_id_str', full_name='cisco_telemetry.Telemetry.node_id_str', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='subscription_id_str', full_name='cisco_telemetry.Telemetry.subscription_id_str', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='encoding_path', full_name='cisco_telemetry.Telemetry.encoding_path', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='collection_id', full_name='cisco_telemetry.Telemetry.collection_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='collection_start_time', full_name='cisco_telemetry.Telemetry.collection_start_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msg_timestamp', full_name='cisco_telemetry.Telemetry.msg_timestamp', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data_gpbkv', full_name='cisco_telemetry.Telemetry.data_gpbkv', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data_gpb', full_name='cisco_telemetry.Telemetry.data_gpb', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='collection_end_time', full_name='cisco_telemetry.Telemetry.collection_end_time', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='node_id', full_name='cisco_telemetry.Telemetry.node_id',
      index=0, containing_type=None, fields=[]),
    _descriptor.OneofDescriptor(
      name='subscription', full_name='cisco_telemetry.Telemetry.subscription',
...
_TELEMETRYFIELD = _descriptor.Descriptor(
  name='TelemetryField',
  full_name='cisco_telemetry.TelemetryField',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='cisco_telemetry.TelemetryField.timestamp', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='cisco_telemetry.TelemetryField.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bytes_value', full_name='cisco_telemetry.TelemetryField.bytes_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='string_value', full_name='cisco_telemetry.TelemetryField.string_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bool_value', full_name='cisco_telemetry.TelemetryField.bool_value', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uint32_value', full_name='cisco_telemetry.TelemetryField.uint32_value', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uint64_value', full_name='cisco_telemetry.TelemetryField.uint64_value', index=6,
      number=8, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sint32_value', full_name='cisco_telemetry.TelemetryField.sint32_value', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sint64_value', full_name='cisco_telemetry.TelemetryField.sint64_value', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='double_value', full_name='cisco_telemetry.TelemetryField.double_value', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='float_value', full_name='cisco_telemetry.TelemetryField.float_value', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fields', full_name='cisco_telemetry.TelemetryField.fields', index=11,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value_by_type', full_name='cisco_telemetry.TelemetryField.value_by_type',
      index=0, containing_type=None, fields=[]),
  ],
...
_TELEMETRYGPBTABLE = _descriptor.Descriptor(
  ...
  full_name='cisco_telemetry.TelemetryGPBTable',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='row', full_name='cisco_telemetry.TelemetryGPBTable.row', index=0,
...
_TELEMETRYROWGPB = _descriptor.Descriptor(
  ...
  full_name='cisco_telemetry.TelemetryRowGPB',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='cisco_telemetry.TelemetryRowGPB.timestamp', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keys', full_name='cisco_telemetry.TelemetryRowGPB.keys', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='content', full_name='cisco_telemetry.TelemetryRowGPB.content', index=2,
